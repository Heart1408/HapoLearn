                ...
                <div class="d-flex">
                    ...
                    <div class="row container">
                        <div class="form-filter">
                            <input type="radio" class="status" name="status" id="new-status" value="desc" {{ request('status') == 'desc' ? 'checked' : '' }} checked>
                            <label class="status-btn btn-newest" for="new-status">Mới nhất</label>
                        </div>
                        <div class="form-filter">
                            <input type="radio" class="status" name="status" id="old-status" value="asc" {{ request('status') == 'asc' ? 'checked' : '' }}>
